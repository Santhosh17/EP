...
public class Estimate_Add_SFD_Booklet extends SuperTestNG
{
	...
	public static class PerfectBound
	{
		...
		public static class EstimateSummary
		{
			...
			{
				WebElement element = driver.findElement(By.xpath("//table/tbody/tr[3]/td/div[2]/div/div[2]/div/div/div[2]/div/table/tbody/tr/td/div/div/table/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr/td/div[2]/div/a/input[@value='Action']"));
				return element;
			}
			...
			{
				WebElement element = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/div[1]/table/tbody/tr[7]/td[1]/div/div/select"));
				return element;
			}
			public static WebElement txt_TaxValue1()
			{
				WebElement element = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/div[1]/table/tbody/tr[7]/td[2]/span"));
				return element;
			}
			public static WebElement txt_TaxValue2()
			{
				WebElement element = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/div[1]/table/tbody/tr[7]/td[3]/span"));
				return element;
			}
			public static WebElement txt_TaxValue3()
			{
				WebElement element = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/div[1]/table/tbody/tr[7]/td[4]/span"));
				return element;
			}
			public static WebElement txt_TaxValue4()
			{
				WebElement element = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/div[1]/table/tbody/tr[7]/td[5]/span"));
				return element;
			}
