...
public class Estimate_Create_SheetFedDigital_Booklet extends SuperTestNG
{
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------------//
		...
		ProjectLibrary.CompareStringTextBoxByID(xlpath, sheetName, 14, 1,"Item Title", "ctl00_ContentPlaceHolder1_UcBooklet_txtItemTitle");
		...
		EprintSpecificLinks.RadwindowXpathXpathXpath("Paper/Stock", "//div[8]/div[1]/div[2]/a/img", "//table/tbody/tr[2]/td[2]/iframe", "//div/div[2]/table/tbody/tr/td[2]/div/a[text()='"+Paperstock+"']");
		...
		ProjectLibrary.StringDDTextBoxID(xlpath, sheetName, 34, 1, "Running Spoilage", "ctl00_ContentPlaceHolder1_UCSingleItem_txtRunningSpoilage");
		
		ProjectLibrary.ChkBoxSelection(xlpath, sheetName, 36, 1, "Double Sided", "ctl00_ContentPlaceHolder1_UCSingleItem_chkDoubleSided");
		...
		{
			ProjectLibrary.SingleSelectDropDownbyVisibleTextbyID(xlpath, sheetName, 35, 1, "Color (Side-1)", "ctl00_ContentPlaceHolder1_UCSingleItem_ddlColors");
		...
		ProjectLibrary.StringDDTextBoxID(xlpath, sheetName, 39, 1, "", "ctl00_ContentPlaceHolder1_UcBooklet_txtNoOfPagesInSection");
		...
		String CustomFinishedBookletSize = Generic.getXlCellValue(xlpath, sheetName, 38, 3);
